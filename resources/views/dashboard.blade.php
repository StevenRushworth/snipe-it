...
@endif
{{-- <p>{{Storage::disk('public')->url(e($snipeSettings->favicon))}}</p> --}}
<div class="row">
  <!-- panel -->
  <div class="col-lg-2 col-xs-6">
      <a href="{{ route('hardware.index') }}">
    <!-- small box -->
    <div class="small-box bg-rpc-green">
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6" >
    ...
    <!-- small box -->
    <div class="small-box bg-rpc-dark_green" >
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6" >
    <!-- small box -->
      <a href="{{ route('accessories.index') }}">
        <div class="small-box bg-rpc-yellow" >
      <div class="inner">
  ...
  <div class="col-lg-2 col-xs-6" >
    ...
    <?php 
        $label = 'Furniture';
        $status_nav = \App\Models\Statuslabel::where('show_in_nav', '=', 1)->where('name','=', $label)->withCount('assets as asset_count')->get()->first();?>
        

          <a href={{"http://asset/statuslabels/" . $status_nav->id}}>
          <div class="small-box bg-rpc-purple" style="background-color: {{$status_nav->color}} !important;">
        <div class="inner">
        
        
            <h3>{{ $status_nav->asset_count }}</h3>
          ...
          @can('index', \App\Models\Consumable::class)
            ...
            <a href={{"http://asset/statuslabels/" . $status_nav->id}} class="small-box-footer">{{ trans('general.view_all') }} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
          @endcan
        </div>
        {{-- @endforeach --}}
  ...
  <div class="col-lg-2 col-xs-6" >
   ...
   <!-- small box -->
   <div class="small-box bg-rpc-grey">
     <div class="inner">
 ...
 <div class="col-lg-2 col-xs-6">
   ...
   <!-- small box -->
   <div class="small-box bg-rpc-grey_light">
     <div class="inner">
      ...
      <div class="box-body">
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <table
                    ...
                    <tr>
                        ...
                        <th class="col-sm-3" id="table_data" data-visible="true" data-field="created_at" data-formatter="dateDisplayFormatter">{{ trans('general.date') }}</th>
                        <th class="col-sm-2" id="table_data" data-visible="true" data-field="admin" data-formatter="usersLinkObjFormatter">{{ trans('general.admin') }}</th>
                        <th class="col-sm-2" id="table_data" data-visible="true" data-field="action_type">{{ trans('general.action') }}</th>
                        <th class="col-sm-3" id="table_data" data-visible="true" data-field="item" data-formatter="polymorphicItemFormatter">{{ trans('general.item') }}</th>
                        <th class="col-sm-2" id="table_data" data-visible="true" data-field="target" data-formatter="polymorphicItemFormatter">{{ trans('general.target') }}</th>
                    </tr>
                    </thead>
                </table>
          ...
          <div class="text-center col-md-12" style="padding-top: 10px;">
            <a href="{{ route('reports.activity') }}" class="btn btn-secondary btn-sm" style="width: 100%">{{ trans('general.viewall') }}</a>
          </div>
        </div><!-- /.row -->
      </div><!-- ./box-body -->
    </div><!-- /.box -->
         ...
         <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="text-center col-md-12" style="padding-top: 10px;">
                        <a href="{{ route('locations.index') }}" class="btn btn-secondary btn-sm" style="width: 100%">{{ trans('general.viewall') }}</a>
                    </div>
                </div> <!-- /.row -->
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="text-center col-md-12" style="padding-top: 10px;">
                        <a href="{{ route('categories.index') }}" class="btn btn-secondary btn-sm" style="width: 100%">{{ trans('general.viewall') }}</a>
                    </div>
                </div> <!-- /.row -->
