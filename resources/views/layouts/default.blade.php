    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                    ...
                    @if (count($status_navs) > 0)
                        @foreach ($status_navs as $status_nav)
                            <li><a href="{{ route('statuslabels.show', ['statuslabel' => $status_nav->id]) }}">
                                <i class="far fa-circle text-red" style="color: {{$status_nav->color}} !important;" aria-hidden="true"></i>
                  ...
                  <li{!! (Request::query('status') == 'Archived' ? ' class="active"' : '') !!}><a href="{{ url('hardware?status=Archived') }}"><i class="far fa-circle text-yellow"></i>
                    {{ trans('general.all') }}
      ...
      <footer class="main-footer hidden-print">
        ...
        @endif
          ...
          <a>©RPCuk 2022  </a><i class="fa-solid fa-earth-europe" style="color: #74AF27; font-size: 10px" aria-hidden="true"></i>
      </footer>
